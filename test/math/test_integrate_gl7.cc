...
TEST_CASE("gl7 - integrates sin(t) on [0, pi] to 2")
{
    ...
    int n = -1;
    auto const r
        = integrate_gl7([](int, double t) { return std::sin(t); }, 0.0, std::numbers::pi_v<double>, cfg, &err, &n);
...
TEST_CASE("gl7 - integrand t * x propagates derivatives in x")
{
    ...
    auto const r = integrate_gl7([&](int, fdd64 t) { return t * x; }, fdd64(0.0), fdd64(1.0), cfg);
